...
function logVerificationToken(rawToken) {
    if (process.env.NODE_ENV === "production")
        return;
    // eslint-disable-next-line no-console
    console.log(`[auth] Verify email token: ${rawToken}`);
}
function buildPreviewLink(path, token) {
...
export async function authRoutes(app) {
    ...
    app.post("/auth/register", async (request, reply) => {
        ...
        return reply.send({
            ...
            previewLink: process.env.NODE_ENV === "production"
                ? undefined
    ...
    app.post("/auth/resend-verification", async (request, reply) => {
        ...
        const previewToken = user && !isUserVerified(user) && process.env.NODE_ENV !== "production"
        ...
        return reply.send({
            ...
            previewLink: previewToken && process.env.NODE_ENV !== "production"
